...
${OBJECTDIR}/Explore/ThemeUtilities.o: Explore/ThemeUtilities.cpp 
	${MKDIR} -p ${OBJECTDIR}/Explore
	${RM} $@.d
	$(COMPILE.cc) -D_FILE_OFFSET_BITS=64 -D_LARGE_FILES -D__WXGTK__ -I/usr/local/lib/wx/include/gtk2-unicode-static-2.9 -I/usr/local/include/wx-2.9 -I/usr/local/include/boost -MMD -MP -MF $@.d -o ${OBJECTDIR}/Explore/ThemeUtilities.o Explore/ThemeUtilities.cpp
