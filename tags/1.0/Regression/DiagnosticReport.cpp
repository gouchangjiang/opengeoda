...
//////////////////////////////////////////////////////////////////////
// DiagnosticReport.cpp: implementation of the DiagnosticReport class.
//
//////////////////////////////////////////////////////////////////////
#include <wx/wxprec.h>
...
bool DiagnosticReport::Allocate()
{
	...
	varNames = new CharPtr[nVar+1];
	varNames[nVar] = new char[16];
	cov		= new DoublePtr[nVar+3]; 
	for (int i=0;i<nVar;i++)
	{
		cov[i] = new double[nVar+3];
		varNames[i] = new char[16];
		varNames[i][15] = '\x0';
	}
