...
//////////////////////////////////////////////////////////////////////
// DiagnosticReport.h: interface for the DiagnosticReport class.
//
//////////////////////////////////////////////////////////////////////
...
public:
	char*				GetWeightName()						{return wName; };
	long				GetNoObservation()				{return nObs; };
	int					GetNoVariable()						{return nVar; };
	bool				IncludeConstant()					{return inclConstant; };
	char*				GetXVarName(int i)				{return varNames[i]; };
	char*				GetYName()								{return yName; };
	CharPtr*		GetXVarNames()						{return varNames;};
	...
	DoublePtr*	GetCovariance()						{return cov;};
...
public:
	void				release_Var();
	void				SetWeightName(char *wname)					{	wName = wname;};
	void			  SetXVarNames(int i, char *vname)		{ varNames[i] = vname; };
	void			  SetYVarName(char *vname)						{ yName = vname; };
...
#endif // !defined(AFX_DIAGNOTICSREPORTS_H__1156E56D_D92A_4F72_8412_2A06E822D417__INCLUDED_)
